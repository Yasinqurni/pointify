  ...
  const rewards = await Promise.all([
    ...
    prisma.reward.create({
      data: {
        ...
        requiredPoints: 0, // ✨ FREE!
        expiryDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year
        isActive: true,
        merchantId: merchants[0].id, // Sweet Dreams Donuts
      },
    }),
    prisma.reward.create({
      data: {
        ...
        expiryDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year
        isActive: true,
        merchantId: merchants[6].id, // Coffee Corner
      },
    }),
    prisma.reward.create({
      data: {
        ...
        expiryDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year
        isActive: true,
        merchantId: merchants[1].id, // Ice Cream Paradise
      },
    }),
    prisma.reward.create({
      data: {
        ...
        expiryDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year
        isActive: true,
        merchantId: merchants[2].id, // Pizza Palace
      },
    }),
    prisma.reward.create({
      data: {
        ...
        expiryDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year
        isActive: true,
        merchantId: merchants[3].id, // Burger House
      },
    }),

    // Sweet Dreams Donuts rewards
    prisma.reward.create({
      data: {
        title: 'Free Donut',
