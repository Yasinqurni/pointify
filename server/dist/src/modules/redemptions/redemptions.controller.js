...
let RedemptionsController = class RedemptionsController {
    ...
    async getUserRedemptionsById(userId) {
    ...
    async getMerchantRedemptionsByAddress(merchantAddress) {
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Confirm claim by redemption ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Claim confirmed successfully',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get user redemptions by user ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'List of user redemptions',
        type: [redemption_dto_1.RedemptionResponseDto],
    ...
    __metadata("design:returntype", Promise)
], RedemptionsController.prototype, "getUserRedemptionsById", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('merchant/:merchantAddress'),
    (0, swagger_1.ApiOperation)({ summary: 'Get merchant redemptions by merchant address' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'List of merchant redemptions',
        type: [redemption_dto_1.RedemptionResponseDto],
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RedemptionsController.prototype, "getMerchantRedemptionsByAddress", null);
