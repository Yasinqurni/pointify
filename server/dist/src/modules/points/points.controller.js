...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get user point reception logs by user ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:returntype", Promise)
], PointsController.prototype, "getUserPointReceptionLogs", null);
__decorate([
    (0, common_1.Get)('user/:userAddress/merchant/:merchantAddress'),
    (0, swagger_1.ApiOperation)({ summary: 'Get user loyalty details for specific merchant' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'User loyalty details for merchant',
    }),
    __param(0, (0, common_1.Param)('userAddress')),
    __param(1, (0, common_1.Param)('merchantAddress')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], PointsController.prototype, "getUserLoyaltyDetails", null);
